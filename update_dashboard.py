...
function initTides(){
  mk('chart-tides',{type:'line',data:{labels:TH,datasets:[
    ...
    scales:{...bO.scales,y:{...bO.scales.y,min:-0.5,title:{display:true,text:'meters (MSL)',color:'#6b7d62',font:{size:10}}}}}});
}
...
def main():
    ...
    print("[Risk] Today: %s (score %d) · tide %.2fm" % (rs[0]["level"],rs[0]["score"],rs[0]["tide"]))
